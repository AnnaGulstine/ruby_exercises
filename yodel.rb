...
# Create a method called articulate which would return the complete yodel as a
# string. Thus, a if you called the articulate method on a yodel with a segment
# of "Oh-di-lay-ee-ay" and count of 4, it would return
# { }"Oh-di-lay-ee-ayOh-di-lay-ee-ayOh-di-lay-ee-ayOh-di-lay-ee-ay"
...
class Yodel # :nodoc:
  ...
  def initialize(params = {})
    @segment = params.fetch(:segment, 'Oh-di-lay-ee-ay')
    @count = params.fetch(:count, 4)
  end
